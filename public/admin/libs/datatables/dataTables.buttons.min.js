...
(function(e) {
    ...
    e.extend(l.prototype, {
        ...
        _expandButton: function(a, b, c, d) {
            for (var g =
                    this.s.dt, h = 0, b = !e.isArray(b) ? [b] : b, f = 0, q = b.length; f < q; f++) {
                    ...
                    if (e.isArray(j)) this._expandButton(a, j, c, d);
                        ...
                        if (p) {
                            ...
                            if (p.conf.buttons) {
                                ...
                                p.collection = e("<" + u.tag + "/>").addClass(u.className).attr("role", "menu");
        ...
        _buildButton: function(a,
            ...
            var q = function(a, b, c, d) {
                ...
                g = a.tag || c.tag,
                j = e("<" + g + "/>").addClass(c.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls",
            ...
            d.tag ? (g = e("<" + d.tag + "/>").html(f(a.text)).addClass(d.className), "a" === d.tag.toLowerCase() && g.attr("href", "#"), j.append(g)) : j.html(f(a.text));
    ...
    l.background = function(a, b, c, d) {
        c === m && (c = 400);
        d || (d = o.body);
        a ? e("<div/>").addClass(b).css("display", "none").insertAfter(d).fadeIn(c) : e("div." + b).fadeOut(c, function() {
        ...
        collection: {
            ...
            action: function(a, b, c, d) {
                var g = e(c).parents("div.dt-button-collection"),
                    ...
                    f = !1,
                    i = c;
                g.length && (f = e(".dt-button-collection").position(), i = g, e("body").trigger("click.dtb-collection"));
                ...
                d._collection.addClass(d.collectionLayout).css("display", "none").insertAfter(i).fadeIn(d.fade);
                ...
                f && "absolute" === g ? d._collection.css({
                    ...
                    left: f.left
                        ...
                        left: a.left
                    }), f = h.offset().top + h.height(), f = a.top + c.outerHeight() + d._collection.outerHeight() - f, g = a.top - d._collection.outerHeight(), g = h.offset().top - g, (f > g || d.dropup) &&
    ...
    i.Api.register("buttons.exportData()", function(a) {
        if (this.context.length) {
            var b = new i.Api(this.context[0]),
                ...
                h =
                e.extend({}, c.modifier);
            b.select && "function" === typeof b.select.info && h.selected === m && b.rows(c.rows, e.extend({
                selected: !0
            }, h)).any() && e.extend(h, {
                selected: !0
            });
    ...
    i.Api.register("buttons.exportInfo()",
        function(a) {
            ...
            b === m || null === b ? b = null : (-1 !== b.indexOf("*") && (b = e.trim(b.replace("*", e("head > title").text()))), b = b.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, ""), (c = t(c.extension)) || (c = ""), b += c);
            c = t(a.title);
