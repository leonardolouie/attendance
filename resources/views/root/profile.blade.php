            ...
            <div class="col-md-6 justify-content-md-end d-md-flex">
                <div class="breadcrumb_nav">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a class="parent-item" href="">Profile</a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li class="active">
            ...
            <div class="card">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="">
                                <form id="profile-password-change__form" action="{{route('admin.profile.updatepassword')}}"
                                    method="POST">
                                    @csrf
...
<script>
    $(document).ready(function () {
        $("#submit").click(function () {
            $("#profile-password-change__form").submit();
        })
    })
</script>
@endsection