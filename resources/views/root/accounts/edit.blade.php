                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('admin.accounts.update')}}" method="POST">
                                ...
                                <div class="">
                                    <hr/>
                                    <button  class="btn btn-primary float-left"  data-toggle="tooltip" data-placement="top" title="Update Account">Save</button>
                                </div>
                            </form>
                        </div>
                        &nbsp
                        <div class="col-md-12">
                            <div class="">
                                <form action="{{route('admin.accounts.submit')}}" method="POST">
                                    ...
                                    <br />
                                    <div class="form-group row">
                                        <label for="password" class="col-sm-2 col-form-label col-form-label-sm">New Password</label>
                                        <div class="col-sm-10">
                            ...
                            <div class="">
                                <hr/>
                                <button id="submit" class="btn btn-primary float-left"  data-toggle="tooltip" data-placement="top" title="Update Account">Save Password</button>
                            </div>
                        </div>
                    </div>
