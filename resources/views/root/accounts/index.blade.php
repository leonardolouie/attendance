                    ...
                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary btn-xs" style="color:#fff;"
                                        href="accounts/{{$user->id}}/edit" data-toggle="tooltip" data-placement="top"
                                        title="Edit"><i class="fa fa-edit"></i></a>

                                    <a class="btn btn-danger btn-xs" href="accounts/{{$user->id}}/deactivate"
                                        data-toggle="tooltip" data-placement="top" title="Deactivate Account"><i
